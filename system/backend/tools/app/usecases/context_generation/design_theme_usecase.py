...
from system.backend.tools.app.prompts.context_generation_prompt import DESIGN_PROMPT
from system.backend.tools.app.references.design_theme_reference import DESIGN_REFERENCE_JSON

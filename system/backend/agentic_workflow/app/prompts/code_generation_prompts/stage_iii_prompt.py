...
- Strictly maintain consistency across all overlays and modals in React.
</RESPONSIBILITIES>
...
- Global components in screen-specific components: `import Icon from '../../../components/AppIcon';`
...
- GRID layouts: Implement responsive columns that scale with screen width

...
<INPUT_CONTEXT>
- Domain, industry patterns and business context from the FIRST stage
- Selected screens and their requirements from the SECOND stage
</INPUT_CONTEXT>

<INSTRUCTIONS>
1. Develop a cohesive color palette that reflects the brand personality and domain
2. Define the overall visual mood and design psychology
3. Balance ideal design with practical development constraints
4. Consider React implementation implications for each design decision
5. Ensure all decisions work together as a unified system without overwhelming users
...
9. Keep it as a reference framework - not overly detailed, but comprehensive enough to guide screen-specific design generation
10. For the typography, must use the 3-4 fonts from the google fonts only that align with the brand personality and domain.
11. Each visual element must earn it's place through the design psychology and the potential success in the user engagement.
...
- For providing the description at the required places, make sure to provide it in a manner that it indicates deeper psychological reasoning to drive the user engagement.
...
<OUTPUT>
{
    ...
    "color_palette": {
        ...
        "neutral": {
            "background": {"color": "hex_code", "description": "reason behind choosing this color"},
            "surface": {"color": "hex_code", "description": "reason behind choosing this color"},
            "text_primary": {"color": "hex_code", "description": "reason behind choosing this color"},
            "text_secondary": {"color": "hex_code", "description": "reason behind choosing this color"},
        },
        "semantic": {
    ...
    "visual_mood": {
        ...
        "personality_traits": "short description of the personality traits"
    },
    "responsive_approach": {

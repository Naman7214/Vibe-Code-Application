...
loggers = {
    ...
    "flutter_stage_ii": setup_logger("flutter_stage_ii", "flutter_stage_ii.log"),
    "flutter_stage_iii": setup_logger("flutter_stage_iii", "flutter_stage_iii.log"),
    "flutter_stage_iv": setup_logger("flutter_stage_iv", "flutter_stage_iv.log"),

...
from system.backend.agentic_workflow.app.repositories.llm_usage_repo import LLMUsageRepository
...
class AnthropicService:
    ...
    async def _make_request(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise JsonResponseError(status_code=exc.response.status_code, detail=error_msg)

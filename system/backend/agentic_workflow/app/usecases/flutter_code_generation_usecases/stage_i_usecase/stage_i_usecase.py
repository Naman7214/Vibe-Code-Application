...
from system.backend.agentic_workflow.app.prompts.flutter_code_generation_prompts.stage_i_prompt import (
    SYSTEM_PROMPT,
    USER_PROMPT,
)
...
from .helper import FlutterStageIHelper


class FlutterStageIUsecase:
    def __init__(
        self,
    ...
    async def execute(self) -> Dict[str, str]:
        """
        Execute Flutter Stage I processing for code generation
        Generates Flutter theme configuration files based on project context
        ...
        try:
            ...
            return {
                "success": True,
                "message": "Flutter Stage I code generation completed successfully",
                "error": None,
            }
            ...
            await self.error_repo.insert_error(
                Error(
                    phase="flutter_code_generation_stage_i",
                    error_message="Error in Flutter Stage I code generation usecase: "
                    + str(e.detail),
            ...
            return {
                "success": False,
                "message": "Error in Flutter Stage I code generation usecase: "
                + str(e.detail),
                "error": e.detail,
            }
            ...
            await self.error_repo.insert_error(
                Error(
                    phase="flutter_code_generation_stage_i",
                    error_message="Unexpected error in Flutter Stage I code generation usecase: "
                    + str(e),
                    stack_trace=str(e),
                )
            )
            return {
                "success": False,
                "message": "Unexpected error in Flutter Stage I code generation usecase: "
                + str(e),
                "error": str(e),
            }

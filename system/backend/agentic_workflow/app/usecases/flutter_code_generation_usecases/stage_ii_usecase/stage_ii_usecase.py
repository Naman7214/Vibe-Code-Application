...
from system.backend.agentic_workflow.app.usecases.flutter_code_generation_usecases.stage_ii_usecase.helper import (
    Helper,
)
    ...
    async def execute(self, request: CodeGenerationRequest) -> JSONResponse:
        try:
            ...
            await self.error_repo.insert_error(
                Error(
                    phase="stage_ii",
                    error_message="Error in the stage ii of code generation usecase: "
                    + str(e.detail),
            ...
            return {
                "success": False,
                "message": "Error in the stage ii of code generation usecase: "
                + str(e.detail),
                "error": e.detail,
            }

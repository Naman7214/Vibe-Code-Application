...
from system.backend.agentic_workflow.app.apis.context_gathering_route import router as context_gathering_router
...
app.include_router(context_gathering_router, prefix="/api/v1")
